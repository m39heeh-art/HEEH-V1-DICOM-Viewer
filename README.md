...
For a reproducible environment check on Windows, run:
...
|   |-- modality_calculators/      # CT and generic quantitative calculators
...
The optional `samples/` directory contains a pseudonymous export archive and
interface screenshots. It helps researchers
...
- Radiomics exposes an IBSI-aligned subset; official IBSI benchmark validation
  is still required for any full-compliance claim.
